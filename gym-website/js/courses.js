const plansData = {
  'training-beginner': {
    ...
    description: 'Идеальная программа для тех, кто только начинает свой путь в фитнесе. Пошаговое освоение техники выполнения упражнений, постепенный рост нагрузки и понятная система тренировок помогут вам безопасно и эффективно достичь своих целей.',
    features: [
  ...
  'training-fullbody': {
    ...
    description: 'Мощная программа тренировок всего тела за три дня в неделю. Комплексная проработка всех мышечных групп с акцентом на развитие силы, выносливости и мышечного роста. Идеально подходит для среднего уровня подготовки.',
    features: [
  ...
  'training-split': {
    ...
    description: 'Продвинутая split-программа для серьёзного роста мышечной массы. Три интенсивные тренировки в неделю с фокусом на отдельные группы мышц. Максимальная эффективность для опытных атлетов.',
    features: [
  ...
  'nutrition-basic': {
    ...
    description: 'Сбалансированный план питания для начинающих. Правильное распределение белков, жиров и углеводов, контроль калорийности и основы здорового питания помогут вам заложить фундамент для достижения ваших фитнес-целей.',
    features: [
  ...
  'nutrition-mass': {
    ...
    description: 'Специализированный план питания для набора мышечной массы. Повышенное содержание белка, правильное распределение макронутриентов и стратегия питания для максимального роста мышц.',
    features: [
  ...
  'nutrition-cut': {
    ...
    description: 'Эффективный план питания для снижения веса с дефицитом калорий. Сохранение мышечной массы, ускорение метаболизма и здоровое похудение без вреда для здоровья.',
    features: [
  ...
  'recovery-basic': {
    ...
    description: 'Основы восстановления после тренировок. Техники растяжки, базовые упражнения на гибкость и рекомендации по отдыху помогут вам быстрее восстанавливаться и избежать травм.',
    features: [
  ...
  'recovery-advanced': {
    ...
    description: 'Комплексная программа восстановления для опытных атлетов. Миофасциальный релиз, мобильность суставов, техники расслабления и оптимизация сна для максимальной производительности.',
    features: [
  ...
  'recovery-injury': {
    ...
    description: 'Специализированная программа восстановления после травм. Реабилитационные упражнения, профилактика повторных травм и безопасное возвращение к полноценным тренировкам.',
    features: [
